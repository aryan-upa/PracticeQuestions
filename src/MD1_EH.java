...
public class MD1_EH {
    ...
    Advantages of Exception Handling
        ...
        3. Grouping and Differentiating error types.
           -- We can make a group of all types of related exception like the exception in the Input Output are in the
    ...
    Checked Exception : The Exceptions which are checked by the compiler during compile time for smoother execution of
        the program at runtime.
            -> FileNotFoundException

    Unchecked Exception : Which are not checked by the compiler at compile time whether the programmers handle the code
    ...
    We can also create our own Exception by extending the Exception class.
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            try{
                ...
                System.out.println("Exception Occurred in Inner Try : \n"+E);
            }
        }
        catch (NumberFormatException E){
            System.out.println("Exception Occurred in Outer Try : \n" +E);
        ...
        try{
            ...
            System.out.println("Exception Catched from throw Keyword " + e);
        }
        finally {
    ...
    void f3(){
        try{
            ...
            System.out.println("Exception Handled in the f3.");
        }
    }
