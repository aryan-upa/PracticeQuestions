...
/**
 * Examples.Employee Class : Helps to create the objects of employee type
 */
public class Employee {
    /**
     * name : String : The name of the Examples.Employee.
     * */
    String name;
    /**
     * DOJ : Integer : The date of joining of the Examples.Employee.
     * */
    Integer DOJ;
     /**
      * Address : String : The Address of the Examples.Employee.
      * */
    String Address;
    ...
    public void add_Info(){
        ...
        System.out.print("Enter the Examples.Employee name : ");
        name = sc.nextLine();
        System.out.print("Enter the Examples.Employee joining year : ");
        DOJ = sc.nextInt();
        String clr = sc.nextLine();
        System.out.print("Enter the Examples.Employee address : ");
        Address = sc.nextLine();
    }
    ...
    public void show_Info(){
        System.out.println("Examples.Employee name : " + name);
        System.out.println("Examples.Employee joining year : " + DOJ);
        System.out.println("Examples.Employee address : " + Address);
    }
    ...
    /*
    Examples.Input : Parameters List :
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter Examples.Employee 1 Details : ");
        n1.add_Info();
        Employee n2 = new Employee();
        System.out.println("Enter Examples.Employee 2 Details : ");
        n2.add_Info();
        Employee n3 = new Employee();
        System.out.println("Enter Examples.Employee 3 Details : ");
        n3.add_Info();
        n1.show_Info();
        n2.show_Info();
        n3.show_Info();
