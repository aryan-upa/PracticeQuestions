...
public class TypeOfVariable {
    ...
    TypeOfVariable(){
        System.out.println("Constructor of Classes.TypeOfVariable");
    }

    static class xyz{
        //here xyz is static class of the Classes.Abc class, hence accessible by the class name.
        void display(){
...
class Abc{
    ...
    Abc(){
        System.out.println("Const. of Classes.Abc");
    }
    class pqr{
...
//            System.out.println(c);
    ...
    public static void main(String[] args) {
        ...
        // we can also write like this, so we do not have to create the object of Classes.Abc class explicitly, but now that object is un-accessible, as it is anonymous.
        Abc.pqr.display();
        q.q = 999;
        q.display2();
        q.display3();
